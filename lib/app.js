...
module.exports = internals.checkStorage;
 ...
 satchel.setStorage = function(storage) {
     var drivers = {
         'localStorage': function(){
             return satchel = 'internals.drivers.secondary';
         },
         'indexedDB': function(){
            if (internals.checkPrimarySupport()) {
                return satchel = 'internals.drivers.primary';
            }
            return {};
         }
     };

     if (typeof drivers[storage] === 'function') {
        return drivers[storage].call();
     }
 };
